...
def Gate_Gen(gate_number,var_num,not_off=True):
    '''
    This function generate random gates
    :param gate_number: number of gates
    :type gate_number: int
    :param var_num: number of input expression variable
    :type var_num:int
    :param not_off: parameter for using Not operation
    :type not_off:bool
    :return: gates as list
    '''
...
def generator(gate_list,not_off=True):
    '''
    This function generate logical expression
    :param gate_list: list of gates (generated by Gate_gen function)
    :type gate_list:list
    :param not_off: parameter for using Not operation
    :type not_off:bool
    :return: Final logical expression as str
    '''
...
def run_generator():
    '''
    This function run generator and save result
    :return: None
    '''
